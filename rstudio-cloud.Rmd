...
subtitle: "`r emo::ji('link')` [rstd.io/design-ds-class](https://rstd.io/design-ds-class)"
...
- Make brief screencasts for getting students oriented with the platform (especially if remote teaching)

- or use mine! [Navigating RStudio Cloud on YouTube](https://www.youtube.com/playlist?list=PLNUVZZ6hfXX05Bs80Hg5MjbOPnEFmwiOM)
...
# `r emo::ji('link')` [rstd.io/design-ds-class](https://rstd.io/design-ds-class)
